...
const URL_PDF_VIEW_MINISTERIO = "http://www.igualdadycalidadcba.gov.ar/CajaTIC/js/web/viewer.html?file=$URL_IMG"; //cuando el link del pdf esta alojado en el ministerio
const URL_PDF_VIEW = "http://www.igualdadycalidadcba.gov.ar/CajaTIC/js/web/viewer.html?file="; //cuando el pdf es de una web cualquiera
